    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-30 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex items-center justify-between h-16">
          ...
          <button onClick={goCreateRecipe} className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-md flex items-center gap-2 font-medium transition-colors">
        ...
        <div className="lg:hidden">
          <div className="flex items-center justify-between h-14">
            ...
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 rounded-md flex items-center gap-1 font-medium transition-colors text-sm">
              <Plus className="w-4 h-4" />
              Create
            </button>
          </div>
